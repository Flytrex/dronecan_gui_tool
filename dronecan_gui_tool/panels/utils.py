...
# CRC-32/MPEG-2 lookup table (polynomial 0x04C11DB7, non-reflected, MSB-first)
_CRC32_MPEG2_TABLE = [
...
def calculate_crc32(data: bytes, crc: int = 0xFFFFFFFF) -> int:
	'''
	@brief  Calculate CRC-32/MPEG-2 checksum matching the C++ implementation.
	@       This implementation uses the CRC-32/MPEG-2 algorithm with:
	...
	for byte in data:
		...
		crc = ((crc << 8) ^ _CRC32_MPEG2_TABLE[table_index]) & 0xFFFFFFFF
